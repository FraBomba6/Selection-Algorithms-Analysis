...
public class Time {
    public static void main(String[] args) {
        try {
            ...
            FileInputStream inputStream = new FileInputStream(new File("Time10.xlsx"));
            ...
            for(int row_index=1; row_index<101; row_index++){
                ...
                cell.setCellValue(getExTimeHeapSelect(input,3));
                cell = row.createCell(1);
                //Executes Quick select
                cell.setCellValue(getExTimeQuickSelect(input,3));
            ...
            FileOutputStream outputStream = new FileOutputStream("Time10.xlsx");
    ...
    /**
     * Computates the resolution error from the executing machine
